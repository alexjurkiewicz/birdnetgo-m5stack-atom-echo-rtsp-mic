...
static String htmlIndex() {
    ...
    h += F(
        ...
        "<select id='sel_buf'><option>256</option><option>512</option><option>1024</option><option>2048</option><option selected>3072</option><option>4096</option><option>8192</option></select>"
